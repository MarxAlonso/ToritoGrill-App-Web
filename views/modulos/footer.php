<!--O tambien puede solo tener el color rgb(7,18,25)sin transparencia-->
<footer class="footer-tipo" style="background-color: black;">
    <div class="container">
        <div class="row">
            ...
            <div class="footer-col col-sm-6 col-lg-3">
                <br>
                <a class="menus" href="inicio" style="font-size: 16px; color:white; margin-bottom: 12px;">Inicio</a>
